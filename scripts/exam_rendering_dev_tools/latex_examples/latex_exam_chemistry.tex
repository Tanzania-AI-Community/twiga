...
\begin{enumerate}
  ...
  \item Match the subatomic particles in List A with their corresponding characteristics in List B. \textbf{(5 Marks)}\par
  \vspace{0.35em}
  \noindent\begin{tabularx}{\linewidth}{@{}p{0.48\linewidth}p{0.48\linewidth}@{}}
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[label=\Alph*., leftmargin=*, itemsep=0.35em, topsep=0.35em, parsep=0pt]
        \item No charge
        \item Found in the nucleus
        \item Positively charged
        \item Has the same mass as an electron
        \item Negatively charged
        \item Orbiting the nucleus
        \item Has the same charge as an electron
      \end{enumerate}
    \end{minipage}
  \end{tabularx}
  \end{questionblock}
