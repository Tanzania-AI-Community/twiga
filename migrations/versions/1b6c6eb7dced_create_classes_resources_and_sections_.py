...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "section_index", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=True
        ),
        sa.Column(
            "section_title", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
        sa.Column(
            "section_type", sqlmodel.sql.sqltypes.AutoString(length=15), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_sections_resource_id"), "sections", ["resource_id"], unique=False
    )
    op.add_column(
        "resources",
        sa.Column("subjects", sa.ARRAY(sa.String(length=50)), nullable=True),
    )
