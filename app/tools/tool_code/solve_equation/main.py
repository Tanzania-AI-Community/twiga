...
async def solve_equation(equation: str, concise: bool = True) -> str:
    ...
    try:
        system_prompt_name = (
            "equation_solver_system_concise_v2" if concise else "equation_solver_system"
        )
        user_prompt_name = (
            "equation_solver_user" if concise else "equation_solver_user"
        ) #equation_solver_user_concise
