...
from app.services.exam_rendering.rendering_utils import (
    detect_section_a_question_type,
    extract_question_number,
    format_answer_lines,
    marks_suffix,
    normalize_list_entries,
...
def build_reportlab_exam_pdf(exam: dict[str, Any], out_path: str | Path) -> None:
    build_pdf(exam, out_path, is_solution=False)


def build_reportlab_solution_pdf(exam: dict[str, Any], out_path: str | Path) -> None:
