...
class OpenAIClient:
    ...
    async def _handle_tool_call(
        ...
        try:
            ...
            response_message = await str(func(**arguments))
    ...
    async def _run_assistant(
        ...
        try:
            ...
            return await self._wait_for_run_completion(run, thread.id, wa_id, verbose)
    ...
    async def generate_response(
        ...
        thread_id = str(dict(check_if_thread_exists(wa_id)).get("thread", ""))
