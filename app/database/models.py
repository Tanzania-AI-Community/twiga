...
class Class(SQLModel, table=True):
    ...
    # TODO: This should be removed and replaced with the value stored in the subjects table
...
class Message(SQLModel, table=True):
    ...
    # TODO: Determine if this validator is used/needed
...
class Resource(SQLModel, table=True):
    ...
    grade_levels: Optional[List[str]] = Field(sa_column=Column(ARRAY(String(10))))
...
# TODO: This table is not currently in use, but shall be used in the future
